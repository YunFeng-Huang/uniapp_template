...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"uniapp-template","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!*****************************************************************!*\
  !*** /Users/bangjinyu/Documents/www/uniapp-template/pages.json ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!*******************************************************************!*\
  !*** /Users/bangjinyu/Documents/www/uniapp-template/api/index.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
_index.default.commit('EXTCONFIG');var _default =
{
  ...
  pagesA: _pagesA_index.default,
  pagesB: _pagesB_index.default,
...
var fetch = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(url, data, config) {var _config$hasToken;var token, baseUrl;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            console.log(_index.default.state.extConfig);
            baseUrl = _index.default.state.extConfig.domain;if (!(
            !token && ((_config$hasToken = config === null || config === void 0 ? void 0 : config.hasToken) !== null && _config$hasToken !== void 0 ? _config$hasToken : true))) {_context.next = 7;break;}_context.next = 6;return (
              _index.default.dispatch('USERLOGIN'));case 6:
            token = uni.getStorageSync('token');case 7:
            ...
            }));case 9:case "end":return _context.stop();}}}, _callee);}));return function fetch(_x, _x2, _x3) {return _ref.apply(this, arguments);};}();var _default =
...
new _vuex.default.Store({
  ...
  mutations: {
    SETSTATE: function SETSTATE(state, _ref) {var type = _ref.type,value = _ref.value;
      state[type] = value;
    },
    EXTCONFIG: function EXTCONFIG(state, value) {
      try {
        ...
        console.log(extConfig, 'state.extConfig');
        var e = res;
        var statusBar = 0;
        var customBar = 0;
  ...
  actions: {
    USERLOGIN: function USERLOGIN(_ref2,


    value) {var commit = _ref2.commit,state = _ref2.state;
      return new Promise(function (resolve, enject) {
        function weixin_login(code) {
          console.log(code, 'code', state);
          _index.default.pages.login({
            "authCode": code,
    ...
    GETUSERINGO: function GETUSERINGO(_ref3, _ref4)


    {var commit = _ref3.commit,state = _ref3.state;var encryptedData = _ref4.encryptedData,iv = _ref4.iv;
      return new Promise(function (resolve) {
        _index.default.pages.weixin_unionId({
    ...
    GETLOCATION: function GETLOCATION(state, value) {
      return new Promise(function (resolve, enject) {
        // 获取位置信息
        uni.getSetting({
          success: function success(res) {
  ...
  modules: {
    setting: _setting.default // 定义子vuex模块 moduleA为模块的命名空间名
  },
  plugins: [dataState] });exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = {
  ...
  mutations: {
    // 保存活动信息
    saveName: function saveName(state, name) {
      state.name = name;
    },
    // 保存用户信息
    saveUserInfo: function saveUserInfo(state, data) {
      state.userInfo = _objectSpread(_objectSpread({}, state.userInfo), data);
    } },
  ...
  actions: {
    getName: function getName(_ref, data) {var commit = _ref.commit;
